...
short: Airbnb Swift style rules used alongside the official Swift guidelines.
summary: Airbnb Swift style rules used alongside the official Swift API Design Guidelines.
read_when:
