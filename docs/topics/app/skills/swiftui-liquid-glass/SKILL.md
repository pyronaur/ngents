...
- For navigation bars and toolbars, prefer **native controls** (system back button, toolbar items) over custom glass surfaces to avoid mixed hit-testing and mismatched press states.
...
- Debugging guide: `references/liquid-glass-debugging.md`
