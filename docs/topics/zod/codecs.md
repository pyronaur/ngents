---
summary: "Zod codecs reference for bidirectional decode/encode transforms and runtime/type behavior"
read_when:
  - Building bidirectional data transforms with Zod codecs.
  - Need to understand decode/encode differences from parse.
---
