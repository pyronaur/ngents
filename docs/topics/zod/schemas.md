---
summary: "Reference for defining Zod schemas, primitives, coercion, literals, and core schema patterns"
read_when:
  - Designing new validation schemas with Zod.
  - Need examples of core schema definitions and coercion behavior.
---
