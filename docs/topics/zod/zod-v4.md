---
summary: "Zod 4 migration guide covering high-impact breaking changes and new error APIs"
read_when:
  - Migrating code from Zod 3 to Zod 4.
  - Need the canonical list of Zod 4 breaking changes.
---
