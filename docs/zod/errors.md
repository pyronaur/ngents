---
summary: "Guide to Zod error types and customization with string errors, params, and error maps"
read_when:
  - Customizing validation error messages in Zod.
  - Troubleshooting Zod parse issues and issue metadata.
---
