---
summary: "Guide for converting between Zod schemas and JSON Schema with `z.toJSONSchema` and `z.fromJSONSchema`"
read_when:
  - Generating JSON Schema from Zod for OpenAPI or structured outputs.
  - Converting existing JSON Schema definitions into Zod schemas.
---
